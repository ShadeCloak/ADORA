...
from transformers import AutoConfig, AutoModel, BitsAndBytesConfig, AutoModelForVision2Seq
...
def _get_critic_model(base_vlm_model, value_head_prefix="score", packing_samples=False):
    class CriticModel(base_vlm_model):
        ...
        def forward(
            ...
            # outputs = getattr(self, self.base_model_prefix)(
            #     input_ids, attention_mask=attention_mask, position_ids=position_ids, pixel_values=pixel_values, image_grid_thw=image_grid_thw
            # )
