...
if __name__ == "__main__":
    # llm = LLMRayActor.remote("/mnt/hwfile/llm-safety/guilujun/Llama-3-8b-sft-mixture", tensor_parallel_size=4)
    llm = LLMRayActor.remote("/mnt/hwfile/lmreason/guilujun/download/InternVL2_5-1B", tensor_parallel_size=2)
    req = ray.get(llm.add_requests.remote(actor_rank=0, sampling_params=None, prompts=["San Franciso is a"]))
    output = ray.get(llm.get_responses.remote(actor_rank=0))
