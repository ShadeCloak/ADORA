...
from openrlhf.models import ActorVL, GPTLMLoss, PolicyLoss, ValueLoss
from openrlhf.models.utils import masked_mean, unpacking_samples, compute_approx_kl
from openrlhf.utils.distributed_sampler import DistributedSampler

from .ppo_utils import AdaptiveKLController, ExperienceVL, FixedKLController, NaiveExperienceMakerVL, NaiveReplayBufferVL
...
class PPOTrainerVL(ABC):
    ...
    def fit(
        ...
        for episode in range(start_episode, args.num_episodes):
            ...
            for rand_prompts, rand_images, rand_references, rand_labels, rand_ids in self.prompts_dataloader:
                for i, experience in enumerate(
                    self.experience_maker.make_experience_list(rand_prompts, rand_images, rand_references, rand_labels, rand_ids, **self.generate_kwargs)
                ):
                    if i == 0:
    ...
    def training_step_actor(self, experience: ExperienceVL) -> Dict[str, float]:
        ...
        # print(f"experience.info: {experience.info}")
